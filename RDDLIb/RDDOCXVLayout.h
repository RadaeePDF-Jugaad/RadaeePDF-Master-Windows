#pragma once
#include "RDDOCX.h"
#include "RDDOCXVPage.h"
#include "RDDOCXVFinder.h"
#include "RDDOCXVThread.h"
...
namespace RDDLib
{
	namespace docxv
	{
        ...
        public:
            ...
            void vOpen(DOCXDoc ^doc, IVCallback ^callback, int page_gap)
            {
                m_doc = doc;
                m_page_gap = page_gap;
                m_callback = callback;
        ...
        class CRDVLayoutThumb : public CRDVLayout
        {
        public:
            enum ALIGN
            {
            ...
            ALIGN m_align;
            bool m_same_height;
            CRDVLayoutThumb(ALIGN align, bool same_height) : CRDVLayout()
            {
                m_same_height = same_height;
                m_align = align;
            }
