...
DOCX_DOC DOCX_Document_open(IRandomAccessStream^ rstream, String^ password, PDF_ERR* err);
DOCX_DOC DOCX_Document_openStream(IPDFStream* str_obj, String^ password, PDF_ERR* err);
DOCX_DOC DOCX_Document_openPath(String^ path, String^ password, PDF_ERR* err);
...
String^ DOCX_Page_getHLink(DOCX_PAGE page, float x, float y);
int DOCX_Page_objsGetCharCount(DOCX_PAGE page);
int DOCX_Page_objsGetCharIndex(DOCX_PAGE page, const PDF_POINT* pt);
String^ DOCX_Page_objsGetString(DOCX_PAGE page, int from, int to);
...
DOCX_FINDER DOCX_Page_findOpen(DOCX_PAGE page, String^ str, bool match_case, bool whole_word);
DOCX_FINDER DOCX_Page_findOpen2(DOCX_PAGE page, String^ str, bool match_case, bool whole_word, bool skip_blanks);
